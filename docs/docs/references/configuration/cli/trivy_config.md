...
```
      ...
      --checks-bundle-repositories strings   OCI registry URL(s) to retrieve checks bundle from (default [mirror.gcr.io/aquasec/trivy-checks:1,ghcr.io/aquasecurity/trivy-checks:1])
