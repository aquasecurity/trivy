...
!!! note
    Scanning SBOMs generated by other tools is possible but may result in inaccurate vulnerability detection, due to the ways each tool records information about packages.
