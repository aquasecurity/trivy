...
## SBOM Discovery
Trivy can discover SBOM for the scanned image, and use it for vulnerability scanning instead of analyzing the image itself. This can speed up and simplify repeated scans of the same image.
...
### Selecting Image Architecture/OS
