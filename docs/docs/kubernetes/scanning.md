...
Scan a cluster and generate a simple summary report. The only outputs currently supported are `json` and `summary`
...
The default report format is json, with the output as below.
