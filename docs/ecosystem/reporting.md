...
## PerspectiveGraph (Community)
PerspectiveGraph ingests vulnerability reports in JSON format generated by Trivy, correlating the images, libraries, and CVEs they contain with cloud, Kubernetes, and IAM data to identify vulnerabilities that can be exploited along a path from the Internet to a sensitive asset.
It is also able to report this path directly from the pull request that introduced the vulnerability.

👉 Get it at: <https://github.com/luiacuaniello/perspectivegraph>
