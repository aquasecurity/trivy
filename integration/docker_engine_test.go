...
func TestRun_WithDockerEngine(t *testing.T) {
	testCases := []struct {
		...
		// $ trivy image <args>
		{
			...
			expectedOutputFile: "testdata/docker_engine/alpine-310.json.golden",
		...
		},
		{
			...
			ignoreUnfixed:      true,
			imageTag:           "alpine:3.10",
			expectedOutputFile: "testdata/docker_engine/alpine-310-ignore-unfixed.json.golden",
			testfile:           "testdata/fixtures/alpine-310.tar.gz",
		},
		{
			...
			imageTag:           "alpine:3.10",
			expectedOutputFile: "testdata/docker_engine/alpine-310-medium-high.json.golden",
			testfile:           "testdata/fixtures/alpine-310.tar.gz",
		},
		{
		...
		},
		{
			...
			imageTag:           "centos:7",
			ignoreUnfixed:      true,
			expectedOutputFile: "testdata/docker_engine/centos-7-ignore-unfixed.json.golden",
			testfile:           "testdata/fixtures/centos-7.tar.gz",
		},
		{
			...
			expectedOutputFile: "testdata/docker_engine/centos-7-low-high.json.golden",
			testfile:           "testdata/fixtures/centos-7.tar.gz",
		},
		{
			name:               "happy path, valid image path, debian:buster",
			imageTag:           "debian:buster",
			expectedOutputFile: "testdata/docker_engine/debian-buster.json.golden",
		...
		},
		{
			...
			ignoreUnfixed:      true,
			imageTag:           "debian:buster",
			expectedOutputFile: "testdata/docker_engine/debian-buster-ignore-unfixed.json.golden",
			testfile:           "testdata/fixtures/debian-buster.tar.gz",
		},
		{
			name:               "happy path, valid image path, debian:stretch",
			imageTag:           "debian:stretch",
			expectedOutputFile: "testdata/docker_engine/debian-stretch.json.golden",
		...
		},
		{
			...
			expectedOutputFile: "testdata/docker_engine/distroless-base.json.golden",
		...
		},
		{
			...
			imageTag:           "gcr.io/distroless/base:latest",
			ignoreUnfixed:      true,
			expectedOutputFile: "testdata/docker_engine/distroless-base-ignore-unfixed.json.golden",
			testfile:           "testdata/fixtures/distroless-base.tar.gz",
		},
		{
			name:               "happy path, valid image path, distroless:python2.7",
			imageTag:           "gcr.io/distroless/python2.7:latest",
			expectedOutputFile: "testdata/docker_engine/distroless-python27.json.golden",
		...
		},
		{
			...
			expectedOutputFile: "testdata/docker_engine/oraclelinux-6-slim.json.golden",
		...
		},
		{
			...
			expectedOutputFile: "testdata/docker_engine/oraclelinux-7-slim.json.golden",
		...
		},
		{
			...
			imageTag:           "ubuntu:18.04",
			ignoreUnfixed:      true,
			expectedOutputFile: "testdata/docker_engine/ubuntu-1804-ignore-unfixed.json.golden",
			testfile:           "testdata/fixtures/ubuntu-1804.tar.gz",
		},
		{
			name:               "happy path, valid image path, registry.redhat.io/ubi7",
			imageTag:           "registry.redhat.io/ubi7",
			expectedOutputFile: "testdata/docker_engine/ubi-7.json.golden",
			testfile:           "testdata/fixtures/ubi-7.tar.gz",
		},
		{
			name:               "happy path, valid image path, opensuse leap 15.1",
			imageTag:           "opensuse/leap:latest",
			expectedOutputFile: "testdata/docker_engine/opensuse-leap-151.json.golden",
		...
		},
		{
			...
			expectedOutputFile: "testdata/docker_engine/opensuse-leap-423.json.golden",
