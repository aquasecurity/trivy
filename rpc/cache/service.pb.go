...
var file_rpc_cache_service_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x66, 0x6f, 0x22, 0xcb, 0x02, 0x0a, 0x08, 0x42, 0x6c, 0x6f, 0x62, 0x49, 0x6e, 0x66,
	...
	0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x6f, 0x70, 0x61,
...
var file_rpc_cache_service_proto_depIdxs = []int32{
	...
	2,  // 6: trivy.cache.v1.PutBlobRequest.blob_info:type_name -> trivy.cache.v1.BlobInfo
	9,  // 7: trivy.cache.v1.PutResponse.os:type_name -> trivy.common.OS
	1,  // 8: trivy.cache.v1.Cache.PutArtifact:input_type -> trivy.cache.v1.PutArtifactRequest
	3,  // 9: trivy.cache.v1.Cache.PutBlob:input_type -> trivy.cache.v1.PutBlobRequest
	5,  // 10: trivy.cache.v1.Cache.MissingBlobs:input_type -> trivy.cache.v1.MissingBlobsRequest
	12, // 11: trivy.cache.v1.Cache.PutArtifact:output_type -> google.protobuf.Empty
	12, // 12: trivy.cache.v1.Cache.PutBlob:output_type -> google.protobuf.Empty
	6,  // 13: trivy.cache.v1.Cache.MissingBlobs:output_type -> trivy.cache.v1.MissingBlobsResponse
