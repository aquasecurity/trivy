...
type Result struct {
	...
	CryptoAssets      []*common.CryptoAsset              `protobuf:"bytes,10,rep,name=crypto_assets,json=cryptoAssets,proto3" json:"crypto_assets,omitempty"`
}
...
func (x *Result) GetCryptoAssets() []*common.CryptoAsset {
	if x != nil {
...
var file_rpc_scanner_service_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x22, 0x95, 0x04, 0x0a, 0x06, 0x52, 0x65, 0x73,
	...
	0x12, 0x3e, 0x0a, 0x0d, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x5f, 0x61, 0x73, 0x73, 0x65, 0x74,
	0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x74, 0x72, 0x69, 0x76, 0x79, 0x2e,
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x41, 0x73, 0x73,
	0x65, 0x74, 0x52, 0x0c, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x41, 0x73, 0x73, 0x65, 0x74, 0x73,
...
var file_rpc_scanner_service_proto_goTypes = []interface{}{
	...
	(*common.CryptoAsset)(nil),              // 14: trivy.common.CryptoAsset
}
var file_rpc_scanner_service_proto_depIdxs = []int32{
	...
	14, // 12: trivy.scanner.v1.Result.crypto_assets:type_name -> trivy.common.CryptoAsset
	1,  // 13: trivy.scanner.v1.ScanOptions.LicenseCategoriesEntry.value:type_name -> trivy.scanner.v1.Licenses
	0,  // 14: trivy.scanner.v1.Scanner.Scan:input_type -> trivy.scanner.v1.ScanRequest
	3,  // 15: trivy.scanner.v1.Scanner.Scan:output_type -> trivy.scanner.v1.ScanResponse
