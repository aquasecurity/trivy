...
type Malware struct {
	...
	Malware  string `protobuf:"bytes,3,opt,name=malware,proto3" json:"malware,omitempty"`
...
func (x *Malware) GetMalware() string {
	if x != nil {
		return x.Malware
	}
	return ""
...
type Result struct {
	...
	Malwares        []*Malware              `protobuf:"bytes,5,rep,name=malwares,proto3" json:"malwares,omitempty"`
}
...
func (x *Result) GetMalwares() []*Malware {
	if x != nil {
		return x.Malwares
	}
	return nil
...
var file_rpc_scanner_service_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x22, 0x6b, 0x0a,
	0x07, 0x4d, 0x61, 0x6c, 0x77, 0x61, 0x72, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65,
	...
	0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x61, 0x6c, 0x77,
	0x61, 0x72, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x61, 0x6c, 0x77, 0x61,
	0x72, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xe5, 0x01, 0x0a, 0x06, 0x52,
	...
	,
...
var file_rpc_scanner_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_rpc_scanner_service_proto_goTypes = []interface{}{
	...
	(*Malware)(nil),              // 3: trivy.scanner.v1.Malware
	(*Result)(nil),               // 4: trivy.scanner.v1.Result
	(*common.OS)(nil),            // 5: trivy.common.OS
	(*common.Vulnerability)(nil), // 6: trivy.common.Vulnerability
...
var file_rpc_scanner_service_proto_depIdxs = []int32{
	...
	5, // 1: trivy.scanner.v1.ScanResponse.os:type_name -> trivy.common.OS
	4, // 2: trivy.scanner.v1.ScanResponse.results:type_name -> trivy.scanner.v1.Result
	6, // 3: trivy.scanner.v1.Result.vulnerabilities:type_name -> trivy.common.Vulnerability
	7, // 4: trivy.scanner.v1.Result.packages:type_name -> trivy.common.Package
	3, // 5: trivy.scanner.v1.Result.malwares:type_name -> trivy.scanner.v1.Malware
