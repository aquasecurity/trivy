...
var file_rpc_common_service_proto_depIdxs = []int32{
	...
	32, // 19: trivy.common.Vulnerability.custom_advisory_data:type_name -> google.protobuf.Value
	32, // 20: trivy.common.Vulnerability.custom_vuln_data:type_name -> google.protobuf.Value
	15, // 21: trivy.common.Vulnerability.data_source:type_name -> trivy.common.DataSource
	30, // 22: trivy.common.Vulnerability.vendor_severity:type_name -> trivy.common.Vulnerability.VendorSeverityEntry
	...
	32, // 25: trivy.common.CustomResource.data:type_name -> google.protobuf.Value
	20, // 26: trivy.common.Code.lines:type_name -> trivy.common.Line
	21, // 27: trivy.common.SecretFinding.code:type_name -> trivy.common.Code
	16, // 28: trivy.common.SecretFinding.layer:type_name -> trivy.common.Layer
	22, // 29: trivy.common.Secret.findings:type_name -> trivy.common.SecretFinding
	...
	26, // 33: trivy.common.LicenseFile.fingings:type_name -> trivy.common.LicenseFinding
	...
	18, // 36: trivy.common.Vulnerability.CvssEntry.value:type_name -> trivy.common.CVSS
...
func file_rpc_common_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpc_common_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*OS); i {
			case 0:
				return &v.state
			case 1:
		...
		file_rpc_common_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[13].Exporter = func(v any, i int) any {
			switch v := v.(*Layer); i {
			case 0:
				return &v.state
			case 1:
		...
		file_rpc_common_service_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[15].Exporter = func(v any, i int) any {
			switch v := v.(*CVSS); i {
			case 0:
				return &v.state
			case 1:
		...
		file_rpc_common_service_proto_msgTypes[16].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[17].Exporter = func(v any, i int) any {
			switch v := v.(*Line); i {
			case 0:
				return &v.state
			case 1:
		...
		file_rpc_common_service_proto_msgTypes[18].Exporter = func(v any, i int) any {
			switch v := v.(*Code); i {
			case 0:
				return &v.state
			case 1:
		...
		file_rpc_common_service_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[20].Exporter = func(v any, i int) any {
			switch v := v.(*Secret); i {
			case 0:
				return &v.state
			case 1:
		...
		file_rpc_common_service_proto_msgTypes[21].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[22].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[23].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[24].Exporter = func(v any, i int) any {
		...
		file_rpc_common_service_proto_msgTypes[25].Exporter = func(v any, i int) any {
