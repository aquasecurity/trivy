...
type Package struct {
	...
	Identifier *PkgIdentifier `protobuf:"bytes,5,opt,name=identifier,proto3" json:"identifier,omitempty"`
	Arch       string         `protobuf:"bytes,6,opt,name=arch,proto3" json:"arch,omitempty"`
	// src package containing some binary packages
	// e.g. bind
	SrcName    string   `protobuf:"bytes,7,opt,name=src_name,json=srcName,proto3" json:"src_name,omitempty"`
	SrcVersion string   `protobuf:"bytes,8,opt,name=src_version,json=srcVersion,proto3" json:"src_version,omitempty"`
	SrcRelease string   `protobuf:"bytes,9,opt,name=src_release,json=srcRelease,proto3" json:"src_release,omitempty"`
	SrcEpoch   int32    `protobuf:"varint,10,opt,name=src_epoch,json=srcEpoch,proto3" json:"src_epoch,omitempty"`
...
type Vulnerability struct {
	...
	References         []string               `protobuf:"bytes,8,rep,name=references,proto3" json:"references,omitempty"`
	PkgIdentifier      *PkgIdentifier         `protobuf:"bytes,9,opt,name=pkg_identifier,json=pkgIdentifier,proto3" json:"pkg_identifier,omitempty"`
...
var file_rpc_common_service_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x52, 0x09, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x69, 0x65, 0x73, 0x22, 0x8b, 0x04,
	...
	0x69, 0x66, 0x69, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x74, 0x72,
	...
	,
	...
	0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x74,
...
var file_rpc_common_service_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_rpc_common_service_proto_goTypes = []interface{}{
	...
	(*Misconfiguration)(nil),         // 9: trivy.common.Misconfiguration
	(*MisconfResult)(nil),            // 10: trivy.common.MisconfResult
	(*PolicyMetadata)(nil),           // 11: trivy.common.PolicyMetadata
	(*DetectedMisconfiguration)(nil), // 12: trivy.common.DetectedMisconfiguration
	(*Vulnerability)(nil),            // 13: trivy.common.Vulnerability
	(*DataSource)(nil),               // 14: trivy.common.DataSource
	(*Layer)(nil),                    // 15: trivy.common.Layer
	(*CauseMetadata)(nil),            // 16: trivy.common.CauseMetadata
	(*CVSS)(nil),                     // 17: trivy.common.CVSS
	(*CustomResource)(nil),           // 18: trivy.common.CustomResource
	(*Line)(nil),                     // 19: trivy.common.Line
	(*Code)(nil),                     // 20: trivy.common.Code
	(*SecretFinding)(nil),            // 21: trivy.common.SecretFinding
	(*Secret)(nil),                   // 22: trivy.common.Secret
	(*DetectedLicense)(nil),          // 23: trivy.common.DetectedLicense
	(*LicenseFile)(nil),              // 24: trivy.common.LicenseFile
	(*LicenseFinding)(nil),           // 25: trivy.common.LicenseFinding
	(*LicenseCategory)(nil),          // 26: trivy.common.LicenseCategory
	(*LicenseType)(nil),              // 27: trivy.common.LicenseType
	nil,                              // 28: trivy.common.Vulnerability.CvssEntry
	nil,                              // 29: trivy.common.Vulnerability.VendorSeverityEntry
...
var file_rpc_common_service_proto_depIdxs = []int32{
	...
	15, // 3: trivy.common.Package.layer:type_name -> trivy.common.Layer
	10, // 4: trivy.common.Misconfiguration.successes:type_name -> trivy.common.MisconfResult
	10, // 5: trivy.common.Misconfiguration.warnings:type_name -> trivy.common.MisconfResult
	10, // 6: trivy.common.Misconfiguration.failures:type_name -> trivy.common.MisconfResult
	10, // 7: trivy.common.Misconfiguration.exceptions:type_name -> trivy.common.MisconfResult
	11, // 8: trivy.common.MisconfResult.policy_metadata:type_name -> trivy.common.PolicyMetadata
	16, // 9: trivy.common.MisconfResult.cause_metadata:type_name -> trivy.common.CauseMetadata
	0,  // 10: trivy.common.DetectedMisconfiguration.severity:type_name -> trivy.common.Severity
	15, // 11: trivy.common.DetectedMisconfiguration.layer:type_name -> trivy.common.Layer
	16, // 12: trivy.common.DetectedMisconfiguration.cause_metadata:type_name -> trivy.common.CauseMetadata
	...
	15, // 15: trivy.common.Vulnerability.layer:type_name -> trivy.common.Layer
	28, // 16: trivy.common.Vulnerability.cvss:type_name -> trivy.common.Vulnerability.CvssEntry
	30, // 17: trivy.common.Vulnerability.published_date:type_name -> google.protobuf.Timestamp
	30, // 18: trivy.common.Vulnerability.last_modified_date:type_name -> google.protobuf.Timestamp
	31, // 19: trivy.common.Vulnerability.custom_advisory_data:type_name -> google.protobuf.Value
	31, // 20: trivy.common.Vulnerability.custom_vuln_data:type_name -> google.protobuf.Value
	14, // 21: trivy.common.Vulnerability.data_source:type_name -> trivy.common.DataSource
	29, // 22: trivy.common.Vulnerability.vendor_severity:type_name -> trivy.common.Vulnerability.VendorSeverityEntry
	20, // 23: trivy.common.CauseMetadata.code:type_name -> trivy.common.Code
	15, // 24: trivy.common.CustomResource.layer:type_name -> trivy.common.Layer
	31, // 25: trivy.common.CustomResource.data:type_name -> google.protobuf.Value
	19, // 26: trivy.common.Code.lines:type_name -> trivy.common.Line
	20, // 27: trivy.common.SecretFinding.code:type_name -> trivy.common.Code
	15, // 28: trivy.common.SecretFinding.layer:type_name -> trivy.common.Layer
	21, // 29: trivy.common.Secret.findings:type_name -> trivy.common.SecretFinding
	0,  // 30: trivy.common.DetectedLicense.severity:type_name -> trivy.common.Severity
	1,  // 31: trivy.common.DetectedLicense.category:type_name -> trivy.common.LicenseCategory.Enum
	2,  // 32: trivy.common.LicenseFile.license_type:type_name -> trivy.common.LicenseType.Enum
	25, // 33: trivy.common.LicenseFile.fingings:type_name -> trivy.common.LicenseFinding
	15, // 34: trivy.common.LicenseFile.layer:type_name -> trivy.common.Layer
	1,  // 35: trivy.common.LicenseFinding.category:type_name -> trivy.common.LicenseCategory.Enum
	17, // 36: trivy.common.Vulnerability.CvssEntry.value:type_name -> trivy.common.CVSS
	0,  // 37: trivy.common.Vulnerability.VendorSeverityEntry.value:type_name -> trivy.common.Severity
