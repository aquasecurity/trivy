...
func (x *Malware) GetFilepath() string {
	if x != nil {
		return x.Filepath
	}
	return ""
...
func (x *Malware) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
var file_rpc_common_service_proto_rawDesc = []byte{
	...
	0x22, 0xd6, 0x05, 0x0a, 0x0d, 0x56, 0x75, 0x6c, 0x6e, 0x65, 0x72, 0x61, 0x62, 0x69, 0x6c, 0x69,
	...
	0x4d, 0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x44, 0x61, 0x74, 0x65, 0x1a, 0x4b, 0x0a, 0x09,
	...
	0x28, 0x01, 0x52, 0x07, 0x76, 0x33, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x22, 0x61, 0x0a, 0x07, 0x4d,
	0x61, 0x6c, 0x77, 0x61, 0x72, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x70, 0x61,
	0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x70, 0x61,
	0x74, 0x68, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x64, 0x35, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x6d, 0x64, 0x35, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x68, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x73, 0x68, 0x61, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2a, 0x44,
...
var file_rpc_common_service_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_rpc_common_service_proto_goTypes = []interface{}{
	...
	(*Malware)(nil),             // 9: trivy.common.Malware
	nil,                         // 10: trivy.common.Vulnerability.CvssEntry
...
var file_rpc_common_service_proto_depIdxs = []int32{
	...
	10, // 4: trivy.common.Vulnerability.cvss:type_name -> trivy.common.Vulnerability.CvssEntry
	11, // 5: trivy.common.Vulnerability.published_date:type_name -> google.protobuf.Timestamp
	11, // 6: trivy.common.Vulnerability.last_modified_date:type_name -> google.protobuf.Timestamp
	8,  // 7: trivy.common.Vulnerability.CvssEntry.value:type_name -> trivy.common.CVSS
