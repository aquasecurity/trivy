...
func (x *LayerMetadata) GetSize() int64 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *LayerMetadata) GetDigest() string {
	if x != nil {
		return x.Digest
	}
	return ""
...
func (x *LayerMetadata) GetCreatedBy() string {
	if x != nil {
		return x.CreatedBy
	}
	return ""
...
func (x *LayerMetadata) GetOpaqueDirs() []string {
	if x != nil {
		return x.OpaqueDirs
	}
	return nil
...
func (x *LayerMetadata) GetWhiteoutFiles() []string {
	if x != nil {
...
var file_rpc_common_service_proto_rawDesc = []byte{
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x42, 0x79, 0x22, 0xbb, 0x01, 0x0a, 0x0d, 0x4c, 0x61,
	0x79, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x73,
	...
	0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x69, 0x66, 0x66, 0x49, 0x64,
	...
	0x1f, 0x0a, 0x0b, 0x6f, 0x70, 0x61, 0x71, 0x75, 0x65, 0x5f, 0x64, 0x69, 0x72, 0x73, 0x18, 0x05,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x6f, 0x70, 0x61, 0x71, 0x75, 0x65, 0x44, 0x69, 0x72, 0x73,
	0x12, 0x25, 0x0a, 0x0e, 0x77, 0x68, 0x69, 0x74, 0x65, 0x6f, 0x75, 0x74, 0x5f, 0x66, 0x69, 0x6c,
	0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0d, 0x77, 0x68, 0x69, 0x74, 0x65, 0x6f,
	0x75, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x22, 0xc3, 0x01, 0x0a, 0x0d, 0x43, 0x61, 0x75, 0x73,
	...
	0x6f, 0x6e, 0x2e, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0xb2, 0x01,
...
var file_rpc_common_service_proto_goTypes = []interface{}{
	...
	(*LayerMetadata)(nil),            // 17: trivy.common.LayerMetadata
...
var file_rpc_common_service_proto_depIdxs = []int32{
	...
	16, // 24: trivy.common.CustomResource.layer:type_name -> trivy.common.Layer
	33, // 25: trivy.common.CustomResource.data:type_name -> google.protobuf.Value
	21, // 26: trivy.common.Code.lines:type_name -> trivy.common.Line
	22, // 27: trivy.common.SecretFinding.code:type_name -> trivy.common.Code
	16, // 28: trivy.common.SecretFinding.layer:type_name -> trivy.common.Layer
	23, // 29: trivy.common.Secret.findings:type_name -> trivy.common.SecretFinding
	...
	27, // 33: trivy.common.LicenseFile.fingings:type_name -> trivy.common.LicenseFinding
	16, // 34: trivy.common.LicenseFile.layer:type_name -> trivy.common.Layer
	1,  // 35: trivy.common.LicenseFinding.category:type_name -> trivy.common.LicenseCategory.Enum
	19, // 36: trivy.common.Vulnerability.CvssEntry.value:type_name -> trivy.common.CVSS
