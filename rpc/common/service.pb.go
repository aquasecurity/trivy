...
var file_rpc_common_service_proto_rawDesc = []byte{
	...
	0x49, 0x43, 0x45, 0x4e, 0x53, 0x45, 0x5f, 0x46, 0x49, 0x4c, 0x45, 0x10, 0x03, 0x2a, 0x44, 0x0a,
...
var file_rpc_common_service_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_rpc_common_service_proto_goTypes = []interface{}{
	...
	nil,                              // 32: trivy.common.Vulnerability.CvssEntry
	nil,                              // 33: trivy.common.Vulnerability.VendorSeverityEntry
...
var file_rpc_common_service_proto_depIdxs = []int32{
	...
	32, // 17: trivy.common.Vulnerability.cvss:type_name -> trivy.common.Vulnerability.CvssEntry
	34, // 18: trivy.common.Vulnerability.published_date:type_name -> google.protobuf.Timestamp
	34, // 19: trivy.common.Vulnerability.last_modified_date:type_name -> google.protobuf.Timestamp
	35, // 20: trivy.common.Vulnerability.custom_advisory_data:type_name -> google.protobuf.Value
	35, // 21: trivy.common.Vulnerability.custom_vuln_data:type_name -> google.protobuf.Value
	17, // 22: trivy.common.Vulnerability.data_source:type_name -> trivy.common.DataSource
	33, // 23: trivy.common.Vulnerability.vendor_severity:type_name -> trivy.common.Vulnerability.VendorSeverityEntry
	...
	35, // 27: trivy.common.CustomResource.data:type_name -> google.protobuf.Value
	...
	20, // 38: trivy.common.Vulnerability.CvssEntry.value:type_name -> trivy.common.CVSS
