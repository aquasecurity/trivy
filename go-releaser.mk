...
build:
	GOOS=linux GOARCH=amd64 go build -o trivy_amd64 $(LDFLAGS) ./cmd/trivy
	GOOS=linux GOARCH=arm64 go build -o trivy_arm64 $(LDFLAGS) ./cmd/trivy
	GOOS=linux go build $(LDFLAGS) ./cmd/trivy
