...
func init() {
	...
	addMap("ALV2", expression.Apache20, false)
	...
	addMap("AFL2", expression.AFL20, false)
	addMap("AFL2.0", expression.AFL20, false)
	addMap("AFL2.1", expression.AFL21, false)
	...
	addMap("APACHE2", expression.Apache20, false)
	addMap("APACHE2.0", expression.Apache20, false)
	addMap("APACHEV2", expression.Apache20, false)
	addMap("APL2", expression.Apache20, false)
	addMap("APLV2.0", expression.Apache20, false)
	...
	addMap("ARTISTIC-1.0-CL8", expression.Artistic10cl8, false)
	...
	addMap("BSD2", expression.BSD2Clause, false)
	addMap("BSD3", expression.BSD3Clause, false)
	addMap("BSL", expression.BSL10, false)
	addMap("BSL-1.0", expression.BSL10, false)
	addMap("BSL1.0", expression.BSL10, false)
	...
	addMap("CDDL1.0", expression.CDDL10, false)
	addMap("CDDL1.1", expression.CDDL11, false)
	...
	addMap("EPL1.0", expression.EPL10, false)
	addMap("EPL2.0", expression.EPL20, false)
	addMap("EUPL-1.0", expression.EUPL10, false)
	addMap("EUPL-1.1", expression.EUPL11, false)
	addMap("EUPL1.0", expression.EUPL10, false)
	addMap("EUPL1.1", expression.EUPL11, false)
	...
	addMap("GFDL-NIV-1.3", expression.GFDL13, false)
	...
	addMap("GPL1", expression.GPL10, false)
	addMap("GPL2", expression.GPL20, false)
	addMap("GPL3", expression.GPL30, false)
	addMap("GPLV1", expression.GPL10, false)
	addMap("GPLV2", expression.GPL20, false)
	addMap("GPLV2+CE", expression.GPL20withclasspathexception, true)
	addMap("GPLV3", expression.GPL30, false)
	...
	addMap("LGPL2", expression.LGPL21, false)
	addMap("LGPL3", expression.LGPL30, false)
	addMap("LGPLLR", expression.LGPLLR, false)
	addMap("LGPLV2", expression.LGPL21, false)
	addMap("LGPLV2.1", expression.LGPL21, false)
	addMap("LGPLV3", expression.LGPL30, false)
	...
	addMap("MPL1", expression.MPL10, false)
	addMap("MPL1.0", expression.MPL10, false)
	addMap("MPL1.1", expression.MPL11, false)
	addMap("MPL2", expression.MPL20, false)
	addMap("MPL2.0", expression.MPL20, false)
	addMap("MPLV1", expression.MPL10, false)
	addMap("MPLV1.0", expression.MPL10, false)
	addMap("MPLV1.1", expression.MPL11, false)
	addMap("MPLV2", expression.MPL20, false)
	addMap("MPLV2.0", expression.MPL20, false)
	...
	addMap("AFFERO GENERAL PUBLIC LICENSE (AGPL) V. 3", expression.AGPL30, false)
	addMap("AGPL V3", expression.AGPL30, false)
	...
	addMap("APACHE 2", expression.Apache20, false)
	addMap("APACHE 2.0", expression.Apache20, false)
	addMap("APACHE LICENSE (2.0)", expression.Apache20, false)
	addMap("APACHE LICENSE (V2.0)", expression.Apache20, false)
	addMap("APACHE LICENSE 2", expression.Apache20, false)
	addMap("APACHE LICENSE 2.0", expression.Apache20, false)
	addMap("APACHE LICENSE V2", expression.Apache20, false)
	addMap("APACHE LICENSE V2.0", expression.Apache20, false)
	addMap("APACHE LICENSE VERSION 2", expression.Apache20, false)
	addMap("APACHE LICENSE VERSION 2.0", expression.Apache20, false)
	addMap("APACHE LICENSE, 2.0", expression.Apache20, false)
	addMap("APACHE LICENSE, ASL VERSION 2.0", expression.Apache20, false)
	addMap("APACHE LICENSE, VERSION 2", expression.Apache20, false)
	addMap("APACHE LICENSE, VERSION 2.0 (HTTP://WWW.APACHE.ORG/LICENSES/LICENSE-2.0)", expression.Apache20, false)
	addMap("APACHE LICENSE, VERSION 2.0", expression.Apache20, false)
	addMap("APACHE LICENSE,VERSION 2.0", expression.Apache20, false)
	addMap("APACHE PUBLIC LICENSE 2.0", expression.Apache20, false)
	addMap("APACHE SOFTWARE LICENSE (APACHE-2.0)", expression.Apache20, false)
	addMap("APACHE SOFTWARE LICENSE - VERSION 2.0", expression.Apache20, false)
	addMap("APACHE SOFTWARE LICENSE 2.0", expression.Apache20, false)
	addMap("APACHE SOFTWARE LICENSE, VERSION 1.1", expression.Apache11, false)
	addMap("APACHE SOFTWARE LICENSE, VERSION 2", expression.Apache20, false)
	addMap("APACHE SOFTWARE LICENSE, VERSION 2.0", expression.Apache20, false)
	addMap("APACHE V 2.0", expression.Apache20, false)
	addMap("APACHE V2", expression.Apache20, false)
	addMap("APACHE V2.0", expression.Apache20, false)
	addMap("APACHE VERSION 2.0", expression.Apache20, false)
	addMap("APACHE, VERSION 2.0", expression.Apache20, false)
	addMap("APACHE-2.0 */ &#39; &QUOT; &#X3D;END --", expression.Apache20, false)
	addMap("ARTISTIC 2.0", expression.Artistic20, false)
	addMap("ARTISTIC LICENSE V2.0", expression.Artistic20, false)
	addMap("ASF 2.0", expression.Apache20, false)
	addMap("ASL 2", expression.Apache20, false)
	addMap("ASL 2.0", expression.Apache20, false)
	addMap("ASL, VERSION 2", expression.Apache20, false)
	addMap("BERKELEY SOFTWARE DISTRIBUTION (BSD)", expression.BSD2Clause, false)
	addMap("BOOST LICENSE V1.0", expression.BSL10, false)
	...
	addMap("BSD LICENSE 3", expression.BSD3Clause, false)
	...
	addMap("CDDL 1.0", expression.CDDL10, false)
	addMap("CDDL 1.1", expression.CDDL11, false)
	addMap("CDDL V1.0", expression.CDDL10, false)
	addMap("CDDL V1.1", expression.CDDL11, false)
	addMap("CDDL, V1.0", expression.CDDL10, false)
	addMap("COMMON DEVELOPMENT AND DISTRIBUTION LICENSE (CDDL) V1.0", expression.CDDL10, false)
	addMap("COMMON DEVELOPMENT AND DISTRIBUTION LICENSE (CDDL) V1.1", expression.CDDL11, false)
	addMap("COMMON DEVELOPMENT AND DISTRIBUTION LICENSE (CDDL) VERSION 1.0", expression.CDDL10, false)
	addMap("COMMON DEVELOPMENT AND DISTRIBUTION LICENSE (CDDL) VERSION 1.1", expression.CDDL11, false)
	addMap("COMMON DEVELOPMENT AND DISTRIBUTION LICENSE (CDDL), VERSION 1.1", expression.CDDL11, false)
	...
	addMap("COMMON PUBLIC LICENSE - V 1.0", expression.CPL10, false)
	addMap("COMMON PUBLIC LICENSE VERSION 1.0", expression.CPL10, false)
	addMap("COMMON PUBLIC", expression.CPL10, false)
	addMap("CPAL 1.0", expression.CPAL10, false)
	addMap("CPAL V1.0", expression.CPAL10, false)
	...
	addMap("CREATIVE COMMONS GNU LGPL, VERSION 2.1", expression.LGPL21, false)
	...
	addMap("ECLIPSE DISTRIBUTION LICENSE (EDL), VERSION 1.0", expression.BSD3Clause, false)
	addMap("ECLIPSE DISTRIBUTION LICENSE (NEW BSD LICENSE)", expression.BSD3Clause, false)
	addMap("ECLIPSE DISTRIBUTION LICENSE - V 1.0", expression.BSD3Clause, false)
	addMap("ECLIPSE DISTRIBUTION LICENSE - VERSION 1.0", expression.BSD3Clause, false)
	addMap("ECLIPSE DISTRIBUTION LICENSE V. 1.0", expression.BSD3Clause, false)
	addMap("ECLIPSE DISTRIBUTION LICENSE V1.0", expression.BSD3Clause, false)
	addMap("ECLIPSE PUBLIC LICENSE (EPL) 1.0", expression.EPL10, false)
	addMap("ECLIPSE PUBLIC LICENSE (EPL) 2.0", expression.EPL20, false)
	addMap("ECLIPSE PUBLIC LICENSE (EPL), VERSION 1.0", expression.EPL10, false)
	addMap("ECLIPSE PUBLIC LICENSE - V 1.0", expression.EPL10, false)
	addMap("ECLIPSE PUBLIC LICENSE - V 2.0", expression.EPL20, false)
	addMap("ECLIPSE PUBLIC LICENSE - V1.0", expression.EPL10, false)
	addMap("ECLIPSE PUBLIC LICENSE - VERSION 1.0", expression.EPL10, false)
	addMap("ECLIPSE PUBLIC LICENSE - VERSION 2.0", expression.EPL20, false)
	addMap("ECLIPSE PUBLIC LICENSE 1.0 (EPL-1.0)", expression.EPL10, false)
	addMap("ECLIPSE PUBLIC LICENSE 1.0", expression.EPL10, false)
	addMap("ECLIPSE PUBLIC LICENSE 2.0 (EPL-2.0)", expression.EPL20, false)
	addMap("ECLIPSE PUBLIC LICENSE V. 2.0", expression.EPL20, false)
	addMap("ECLIPSE PUBLIC LICENSE V1.0", expression.EPL10, false)
	addMap("ECLIPSE PUBLIC LICENSE V2.0", expression.EPL20, false)
	addMap("ECLIPSE PUBLIC LICENSE VERSION 1.0", expression.EPL10, false)
	addMap("ECLIPSE PUBLIC LICENSE VERSION 2.0", expression.EPL20, false)
	addMap("ECLIPSE PUBLIC LICENSE, VERSION 1.0", expression.EPL10, false)
	addMap("ECLIPSE PUBLIC LICENSE, VERSION 2.0", expression.EPL20, false)
	addMap("ECLIPSE PUBLIC", expression.EPL10, false)
	addMap("ECLIPSE PUBLISH LICENSE, VERSION 1.0", expression.EPL10, false)
	addMap("EDL 1.0", expression.BSD3Clause, false)
	addMap("EPL (ECLIPSE PUBLIC LICENSE), V1.0", expression.EPL10, false)
	addMap("EPL 1.0", expression.EPL10, false)
	addMap("EPL 2.0", expression.EPL20, false)
	addMap("EPL V1.0", expression.EPL10, false)
	addMap("EPL V2.0", expression.EPL20, false)
	...
	addMap("EUPL 1.0", expression.EUPL10, false)
	addMap("EUPL 1.1", expression.EUPL11, false)
	addMap("EUPL V1.0", expression.EUPL10, false)
	addMap("EUPL V1.1", expression.EUPL11, false)
	addMap("EUROPEAN UNION PUBLIC LICENSE (EUPL V.1.1)", expression.EUPL11, false)
	addMap("EUROPEAN UNION PUBLIC LICENSE 1.0 (EUPL 1.0)", expression.EUPL10, false)
	addMap("EUROPEAN UNION PUBLIC LICENSE 1.0", expression.EUPL10, false)
	addMap("EUROPEAN UNION PUBLIC LICENSE 1.1 (EUPL 1.1)", expression.EUPL11, false)
	addMap("EUROPEAN UNION PUBLIC LICENSE 1.1", expression.EUPL11, false)
	addMap("EUROPEAN UNION PUBLIC LICENSE, VERSION 1.1", expression.EUPL11, false)
	...
	addMap("GNU AFFERO GENERAL PUBLIC LICENSE V3 (AGPLV3)", expression.AGPL30, false)
	...
	addMap("GNU AFFERO GENERAL PUBLIC LICENSE V3", expression.AGPL30, false)
	addMap("GNU AFFERO GENERAL PUBLIC LICENSE, VERSION 3", expression.AGPL30, false)
	addMap("GNU FREE DOCUMENTATION LICENSE (GFDL-1.3)", expression.GFDL13, false)
	addMap("GNU GENERAL LESSER PUBLIC LICENSE (LGPL) VERSION 2.1", expression.LGPL21, false)
	addMap("GNU GENERAL LESSER PUBLIC LICENSE (LGPL) VERSION 3.0", expression.LGPL30, false)
	addMap("GNU GENERAL PUBLIC LICENSE (GPL) V. 2", expression.GPL20, false)
	addMap("GNU GENERAL PUBLIC LICENSE (GPL) V. 3", expression.GPL30, false)
	...
	addMap("GNU GENERAL PUBLIC LICENSE 3", expression.GPL30, false)
	addMap("GNU GENERAL PUBLIC LICENSE V2 (GPLV2)", expression.GPL20, false)
	...
	addMap("GNU GENERAL PUBLIC LICENSE V3 (GPLV3)", expression.GPL30, false)
	addMap("GNU GENERAL PUBLIC LICENSE V3 OR LATER (GPLV3+)", expression.GPL30, true)
	addMap("GNU GENERAL PUBLIC LICENSE VERSION 2 (GPLV2)", expression.GPL20, false)
	addMap("GNU GENERAL PUBLIC LICENSE VERSION 2", expression.GPL20, false)
	addMap("GNU GENERAL PUBLIC LICENSE VERSION 2, JUNE 1991", expression.GPL20, false)
	addMap("GNU GENERAL PUBLIC LICENSE VERSION 3 (GPL V3)", expression.GPL30, false)
	...
	addMap("GNU GENERAL PUBLIC LICENSE, VERSION 2", expression.GPL20, false)
	addMap("GNU GENERAL PUBLIC LICENSE, VERSION 2, WITH THE CLASSPATH EXCEPTION", expression.GPL20withclasspathexception, false)
	addMap("GNU GENERAL PUBLIC LICENSE, VERSION 3", expression.GPL30, false)
	addMap("GNU GPL V2", expression.GPL20, false)
	addMap("GNU GPL V3", expression.GPL30, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE (LGPL), VERSION 2.1", expression.LGPL21, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE (LGPL), VERSION 3", expression.LGPL30, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE 2.1", expression.LGPL21, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE V2 (LGPLV2)", expression.LGPL20, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE V2 OR LATER (LGPLV2+)", expression.LGPL20, true)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE V3 (LGPLV3)", expression.LGPL30, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE V3 OR LATER (LGPLV3+)", expression.LGPL30, true)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE V3", expression.LGPL30, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE V3.0", expression.LGPL30, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE VERSION 2.1 (LGPLV2.1)", expression.LGPL21, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE VERSION 2.1", expression.LGPL21, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE VERSION 2.1, FEBRUARY 1999", expression.LGPL21, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE, VERSION 2.1", expression.LGPL21, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE, VERSION 2.1, FEBRUARY 1999", expression.LGPL21, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE, VERSION 3", expression.LGPL30, false)
	addMap("GNU LESSER GENERAL PUBLIC LICENSE, VERSION 3.0", expression.LGPL30, false)
	addMap("GNU LGP (GNU GENERAL PUBLIC LICENSE), V2", expression.LGPL20, false)
	addMap("GNU LGPL (GNU LESSER GENERAL PUBLIC LICENSE), V2.1", expression.LGPL21, false)
	...
	addMap("GNU LGPL V2", expression.LGPL20, false)
	addMap("GNU LGPL V2.1", expression.LGPL21, false)
	addMap("GNU LGPL V3", expression.LGPL30, false)
	addMap("GNU LIBRARY GENERAL PUBLIC LICENSE V2.1", expression.LGPL21, false)
	addMap("GNU LIBRARY OR LESSER GENERAL PUBLIC LICENSE VERSION 2.0 (LGPLV2)", expression.LGPL20, false)
	...
	addMap("GPL V2", expression.GPL20, false)
	addMap("GPL V3", expression.GPL30, false)
	addMap("GPL VERSION 2", expression.GPL20, false)
	...
	addMap("LGPL 3", expression.LGPL30, false)
	addMap("LGPL 3.0", expression.LGPL30, false)
	addMap("LGPL V2", expression.LGPL20, false)
	addMap("LGPL V2.1", expression.LGPL21, false)
	addMap("LGPL V3", expression.LGPL30, false)
	addMap("LGPL V3.0", expression.LGPL30, false)
	addMap("LGPL, V2.1", expression.LGPL21, false)
	addMap("LGPL, VERSION 2.1", expression.LGPL21, false)
	addMap("LGPL, VERSION 3.0", expression.LGPL30, false)
	...
	addMap("MOCKRUNNER LICENSE, BASED ON APACHE SOFTWARE LICENSE, VERSION 1.1", expression.Apache11, false)
	...
	addMap("MOZILLA PUBLIC LICENSE V 2.0", expression.MPL20, false)
	addMap("MOZILLA PUBLIC LICENSE VERSION 1.0", expression.MPL10, false)
	addMap("MOZILLA PUBLIC LICENSE VERSION 1.1", expression.MPL11, false)
	addMap("MOZILLA PUBLIC LICENSE VERSION 2.0", expression.MPL20, false)
	addMap("MOZILLA PUBLIC LICENSE, VERSION 2.0", expression.MPL20, false)
	...
	addMap("MPL 2", expression.MPL20, false)
	addMap("MPL 2.0", expression.MPL20, false)
	addMap("MPL V2", expression.MPL20, false)
	...
	addMap("OPEN SOFTWARE LICENSE V. 3.0", expression.OSL30, false)
	addMap("PERL ARTISTIC V2", expression.Artistic10Perl, false)
	...
	addMap("SIL OPEN FONT LICENSE VERSION 1.1", expression.OFL11, false)
	...
	addMap("UNIVERSAL PERMISSIVE LICENSE, VERSION 1.0", expression.UPL10, false)
	...
	addMap("ZOPE V2.1", expression.ZPL21, false)
	addMap("ZPL 2.1", expression.ZPL21, false)
	addMap("['MIT']", expression.MIT, false)
}
...
func normalizeKeyAndSuffix(name string) expression.SimpleExpr {
...
func NormalizeLicense(name string) expression.SimpleExpr {
	normalized := normalizeKeyAndSuffix(name)
