...
import (
	...
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/alma"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/alpine"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/amazon"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/chainguard"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/debian"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/mariner"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/oracle"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/photon"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/redhat"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/rocky"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/suse"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/ubuntu"
	"github.com/deepfactor-io/trivy/pkg/detector/ospkg/wolfi"
