...
func TestConstraints_Check(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "multiple constraints OR logic (first satisfied)",
			constraints: ">=2.0.0, <1.0.0",
			version:     "2.1.0",
			want:        true,
		},
		{
			name:        "multiple constraints OR logic (second satisfied)",
			constraints: ">=2.0.0, <1.0.0",
			version:     "0.9.0",
			want:        true,
		},
		{
			name:        "multiple constraints OR logic (none satisfied)",
			constraints: ">=2.0.0, <1.0.0",
			version:     "1.5.0",
			want:        false,
		},
