...
import (
	...
	"github.com/aquasecurity/trivy/pkg/terraform/context"
...
func NewAttribute(attr *hcl.Attribute, ctx *context.Context, module string, parent defsecTypes.MisconfigMetadata, parentRef Reference, moduleSource string, moduleFS fs.FS) *Attribute {
	...
	metadata := defsecTypes.NewMisconfigMetadata(rng, reference.String())
	return &Attribute{
		hclAttribute: attr,
		ctx:          ctx,
		module:       module,
...
func (a *Attribute) GetMetadata() defsecTypes.MisconfigMetadata {
	return a.metadata
}
