...
func (ignores Ignores) Covering(modules Modules, m defsecTypes.MisconfigMetadata, workspace string, ids ...string) *Ignore {
...
func (ignore Ignore) Covering(modules Modules, m defsecTypes.MisconfigMetadata, workspace string, ids ...string) bool {
...
func (ignore Ignore) MatchParams(modules Modules, blockMetadata *defsecTypes.MisconfigMetadata) bool {
