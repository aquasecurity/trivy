	...
	}{
		{
			...
			args: args{
				...
				flags: []string{
					...
					"-w",
					"-X=foo=bar",
					"-X='github.com/aquasecurity/trivy/internal/version/app.ver=v0.50.1'",
				},
			},
			want: "v0.50.1",
		},
		{
			...
			args: args{
				...
				flags: []string{
					...
					"-w",
					"-X=foo=bar",
					"-X='github.com/aquasecurity/trivy/internal/version.Version=v0.50.1'",
				},
			},
			want: "v0.50.1",
		},
		...
		},
		{
			...
			args: args{
				...
				flags: []string{
					...
					"-w",
					"-X=foo=bar",
					"-X='github.com/aquasecurity/trivy/internal/version.Ver=v0.50.1'",
				},
			},
			want: "v0.50.1",
		},
		{
			...
			args: args{
				...
				flags: []string{
					...
					"-w",
					"-X=foo=bar",
					"-X=\"github.com/aquasecurity/trivy/internal/version.Ver=0.50.1\"",
				},
			},
			want: "0.50.1",
		},
