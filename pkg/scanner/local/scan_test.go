					...
					Misconfigurations: []types.DetectedMisconfiguration{
						{
							...
							Namespace:  "main.kubernetes.id100",
							Severity:   "HIGH",
							PrimaryURL: "https://avd.aquasec.com/misconfig/id100",
							References: []string{
								"https://avd.aquasec.com/misconfig/id100",
							},
					...
					Misconfigurations: []types.DetectedMisconfiguration{
						{
							...
							Severity:   "MEDIUM",
							Status:     types.StatusFailure,
							PrimaryURL: "https://avd.aquasec.com/misconfig/id300",
							References: []string{
								"https://avd.aquasec.com/misconfig/id300",
							},
							Layer: ftypes.Layer{
								DiffID: "sha256:9922bc15eeefe1637b803ef2106f178152ce19a391f24aec838cbe2e48e73303",
							},
