							...
							Applications: []types.Application{
								{
									...
									Libraries: []types.Package{
										{ID: "actioncable@5.2.3", Name: "actioncable", Version: "5.2.3", DependsOn: []string{"actionpack@5.2.3", "nio4r@2.3.1", "websocket-driver@0.7.0"}},
										{ID: "actionmailer@5.2.3", Name: "actionmailer", Version: "5.2.3", DependsOn: []string{"actionpack@5.2.3", "actionview@5.2.3", "activejob@5.2.3", "mail@2.7.1", "rails-dom-testing@2.0.3"}},
										{ID: "actionpack@5.2.3", Name: "actionpack", Version: "5.2.3", DependsOn: []string{"actionview@5.2.3", "activesupport@5.2.3", "rack@2.0.7", "rack-test@1.1.0", "rails-dom-testing@2.0.3", "rails-html-sanitizer@1.0.3"}},
										{ID: "actionview@5.2.3", Name: "actionview", Version: "5.2.3", DependsOn: []string{"activesupport@5.2.3", "builder@3.2.3", "erubi@1.8.0", "rails-dom-testing@2.0.3", "rails-html-sanitizer@1.0.3"}},
										{ID: "activejob@5.2.3", Name: "activejob", Version: "5.2.3", DependsOn: []string{"activesupport@5.2.3", "globalid@0.4.2"}},
										{ID: "activemodel@5.2.3", Name: "activemodel", Version: "5.2.3", DependsOn: []string{"activesupport@5.2.3"}},
										{ID: "activerecord@5.2.3", Name: "activerecord", Version: "5.2.3", DependsOn: []string{"activemodel@5.2.3", "activesupport@5.2.3", "arel@9.0.0"}},
										{ID: "activestorage@5.2.3", Name: "activestorage", Version: "5.2.3", DependsOn: []string{"actionpack@5.2.3", "activerecord@5.2.3", "marcel@0.3.3"}},
										{ID: "activesupport@5.2.3", Name: "activesupport", Version: "5.2.3", DependsOn: []string{"concurrent-ruby@1.1.5", "i18n@1.6.0", "minitest@5.11.3", "tzinfo@1.2.5"}},
										...
										{ID: "faker@1.9.3", Name: "faker", Version: "1.9.3", DependsOn: []string{"i18n@1.6.0"}},
										{ID: "globalid@0.4.2", Name: "globalid", Version: "0.4.2", DependsOn: []string{"activesupport@5.2.3"}},
										{ID: "i18n@1.6.0", Name: "i18n", Version: "1.6.0", DependsOn: []string{"concurrent-ruby@1.1.5"}},
										{ID: "jaro_winkler@1.5.2", Name: "jaro_winkler", Version: "1.5.2"},
										{ID: "json@2.2.0", Name: "json", Version: "2.2.0"},
										{ID: "loofah@2.2.3", Name: "loofah", Version: "2.2.3", DependsOn: []string{"crass@1.0.4", "nokogiri@1.10.3"}},
										{ID: "mail@2.7.1", Name: "mail", Version: "2.7.1", DependsOn: []string{"mini_mime@1.0.1"}},
										{ID: "marcel@0.3.3", Name: "marcel", Version: "0.3.3", DependsOn: []string{"mimemagic@0.3.3"}},
										...
										{ID: "nokogiri@1.10.3", Name: "nokogiri", Version: "1.10.3", DependsOn: []string{"mini_portile2@2.4.0"}},
										{ID: "parallel@1.17.0", Name: "parallel", Version: "1.17.0"},
										{ID: "parser@2.6.3.0", Name: "parser", Version: "2.6.3.0", DependsOn: []string{"ast@2.4.0"}},
										{ID: "pry@0.12.2", Name: "pry", Version: "0.12.2", DependsOn: []string{"coderay@1.1.2", "method_source@0.9.2"}},
										{ID: "psych@3.1.0", Name: "psych", Version: "3.1.0"},
										{ID: "rack@2.0.7", Name: "rack", Version: "2.0.7"},
										{ID: "rack-test@1.1.0", Name: "rack-test", Version: "1.1.0", DependsOn: []string{"rack@2.0.7"}},
										{ID: "rails@5.2.0", Name: "rails", Version: "5.2.0", DependsOn: []string{"actioncable@5.2.3", "actionmailer@5.2.3", "actionpack@5.2.3", "actionview@5.2.3", "activejob@5.2.3", "activemodel@5.2.3", "activerecord@5.2.3", "activestorage@5.2.3", "activesupport@5.2.3", "railties@5.2.3", "sprockets-rails@3.2.1"}},
										{ID: "rails-dom-testing@2.0.3", Name: "rails-dom-testing", Version: "2.0.3", DependsOn: []string{"activesupport@5.2.3", "nokogiri@1.10.3"}},
										{ID: "rails-html-sanitizer@1.0.3", Name: "rails-html-sanitizer", Version: "1.0.3", DependsOn: []string{"loofah@2.2.3"}},
										{ID: "railties@5.2.3", Name: "railties", Version: "5.2.3", DependsOn: []string{"actionpack@5.2.3", "activesupport@5.2.3", "method_source@0.9.2", "rake@12.3.2", "thor@0.20.3"}},
										{ID: "rainbow@3.0.0", Name: "rainbow", Version: "3.0.0"},
										{ID: "rake@12.3.2", Name: "rake", Version: "12.3.2"},
										{ID: "rubocop@0.67.2", Name: "rubocop", Version: "0.67.2", DependsOn: []string{"jaro_winkler@1.5.2", "parallel@1.17.0", "parser@2.6.3.0", "psych@3.1.0", "rainbow@3.0.0", "ruby-progressbar@1.10.0", "unicode-display_width@1.5.0"}},
										{ID: "ruby-progressbar@1.10.0", Name: "ruby-progressbar", Version: "1.10.0"},
										{ID: "sprockets@3.7.2", Name: "sprockets", Version: "3.7.2", DependsOn: []string{"concurrent-ruby@1.1.5", "rack@2.0.7"}},
										{ID: "sprockets-rails@3.2.1", Name: "sprockets-rails", Version: "3.2.1", DependsOn: []string{"actionpack@5.2.3", "activesupport@5.2.3", "sprockets@3.7.2"}},
										{ID: "thor@0.20.3", Name: "thor", Version: "0.20.3"},
										{ID: "thread_safe@0.3.6", Name: "thread_safe", Version: "0.3.6"},
										{ID: "tzinfo@1.2.5", Name: "tzinfo", Version: "1.2.5", DependsOn: []string{"thread_safe@0.3.6"}},
										{ID: "unicode-display_width@1.5.0", Name: "unicode-display_width", Version: "1.5.0"},
										{ID: "websocket-driver@0.7.0", Name: "websocket-driver", Version: "0.7.0", DependsOn: []string{"websocket-extensions@0.1.3"}},
