...
func Write(report types.Report, option Option) error {
    ...
    log.Logger.Warnf("Trivy currently only supports the scanning of SBOMs generated by Trivy itself. Using the SBOM generated from this command with other scanners will likely lead to false negative results")
