...
var (
	...
	ignorePolicies = cli.StringSliceFlag{
		Name:    "ignore-policy",
		Usage:   "specify the Rego file to evaluate each vulnerability, can be specified multiple times",
		EnvVars: []string{"TRIVY_IGNORE_POLICY", "TRIVY_IGNORE_POLICIES"},
	}
