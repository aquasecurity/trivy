...
func initializeDockerScanner(ctx context.Context, imageName string, artifactCache cache.ArtifactCache,
	localArtifactCache cache.LocalArtifactCache, imageOpt ftypes.ImageOptions, artifactOption artifact.Option, runtimes types.Runtimes) (
...
func initializeRemoteDockerScanner(ctx context.Context, imageName string, artifactCache cache.ArtifactCache,
	remoteScanOptions client.ScannerOption, imageOpt ftypes.ImageOptions, artifactOption artifact.Option) (
	scanner.Scanner, func(), error) {
