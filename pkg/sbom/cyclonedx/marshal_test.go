...
func TestMarshaler_Marshal(t *testing.T) {
	tests := []struct {
		...
		{
			name: "happy path for use SrcVersion oses",
			inputReport: types.Report{
				SchemaVersion: report.SchemaVersion,
				ArtifactName:  "python:3.9.15-bullseye",
				ArtifactType:  ftypes.ArtifactContainerImage,
				Metadata: types.Metadata{
					OS: &ftypes.OS{
						Family: fos.Debian,
						...
						Vulnerabilities: []types.DetectedVulnerability{
							{
								...
								Vulnerability: dtypes.Vulnerability{
									...
									Severity:         dtypes.SeverityLow.String(),
									PublishedDate:    lo.ToPtr(time.Date(2022, 2, 11, 21, 15, 0, 0, time.UTC)),
									LastModifiedDate: lo.ToPtr(time.Date(2022, 2, 22, 21, 47, 0, 0, time.UTC)),
								},
							},
			...
			want: &cdx.BOM{
				...
				Components: &[]cdx.Component{
					{
						BOMRef:     "pkg:deb/debian/bsdutils@1:2.36.1-8+deb11u1?distro=debian-11.5",
						Type:       "library",
						Name:       "bsdutils",
						Version:    "1:2.36.1-8+deb11u1",
						PackageURL: "pkg:deb/debian/bsdutils@1:2.36.1-8+deb11u1?distro=debian-11.5",
						Properties: &[]cdx.Property{
							{
								Name:  "aquasecurity:trivy:PkgID",
								Value: "bsdutils@1:2.36.1-8+deb11u1",
							},
							{
								Name:  "aquasecurity:trivy:PkgType",
								Value: "debian",
				...
				Vulnerabilities: &[]cdx.Vulnerability{
					{
						...
						Updated:   "2022-02-22T21:47:00+00:00",
						Source: &cdx.Source{
							Name: string(vulnerability.Debian),
							URL:  "https://salsa.debian.org/security-tracker-team/security-tracker",
						},
						CWEs: &[]int{
							209,
						...
						Advisories: &[]cdx.Advisory{
							{
								URL: "https://access.redhat.com/security/cve/CVE-2022-0563",
							},
							{
				...
				Dependencies: &[]cdx.Dependency{
					{
						Ref: "3ff14136-e09f-4df9-80ea-000000000003",
						Dependencies: &[]string{
							"pkg:deb/debian/bsdutils@1:2.36.1-8+deb11u1?distro=debian-11.5",
						},
					},
					{
						Ref: "3ff14136-e09f-4df9-80ea-000000000002",
