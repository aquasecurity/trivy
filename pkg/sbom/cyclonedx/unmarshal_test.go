...
func TestUnmarshaler_Unmarshal(t *testing.T) {
	tests := []struct {
		...
		{
			name:      "happy path - syft SBOM scan of Image",
			inputFile: "testdata/happy/syft-scan-image.json",
			want: types.SBOM{
				Applications: []ftypes.Application{
					{
						Type:     "jar",
						...
						Packages: ftypes.Packages{
							{
								...
								Identifier: ftypes.PkgIdentifier{
									...
									BOMRef: "pkg:maven/commons-io/commons-io@2.13.0?package-id=1f7c232ab1d04418",
								},
								Version:            "2.13.0",
								Release:            "",
								Epoch:              0,
		...
		{
			name:      "happy path - syft SBOM scan of FS",
			inputFile: "testdata/happy/syft-scan-fs.json",
			want: types.SBOM{
				Applications: []ftypes.Application{
					ftypes.Application{
						Type:     "jar",
