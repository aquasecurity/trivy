...
// Evidence converts the file paths of the component into `evidence.occurrences`.
// cf. https://cyclonedx.org/docs/1.6/json/#components_items_evidence_occurrences
func (*Marshaler) Evidence(files []core.File) *cdx.Evidence {
