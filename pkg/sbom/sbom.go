...
func DetectFormat(r io.ReadSeeker) (Format, error) {
  log.Logger.Warnf("Trivy currently only supports the scanning of SBOMs generated by Trivy itself. Passing in SBOMs generated by other tools will lead to false negative results")
