...
func Extract(object cryptox509.Object) []ftypes.CryptoAsset {
	...
	case cryptox509.ObjectEncryptedPrivateKey:
		return extractEncryptedPrivateKey(object.KeyFormat, object.Encoding, object.EncryptionFormat,
...
// extractEncryptedPrivateKey describes an encrypted private key container. Its algorithm,
// size and curve live inside the encrypted payload and stay unset. The container format
// selects the identification method, because each method digests a different canonical form.
func extractEncryptedPrivateKey(
	format ftypes.CryptoKeyFormat,
	encoding ftypes.CryptoEncoding,
	encryption cryptox509.EncryptionFormat,
	digest string,
) []ftypes.CryptoAsset {
	var method ftypes.CryptoIdentityMethod
	switch encryption {
	case cryptox509.EncryptionFormatPKCS8:
		method = ftypes.CryptoMethodEncryptedPKCS8SHA256
	case cryptox509.EncryptionFormatRFC1423:
