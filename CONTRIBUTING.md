...
## Issues
- Feel free to open issues for any reason. When you open a new issue you'll have to select a the issue kind: bug/feature/support and fill the required information based on the selected template.
