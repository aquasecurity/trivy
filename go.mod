...
// DON'T APPROVE IT, DON'T MERGE IT - just for testing
replace github.com/aquasecurity/trivy-kubernetes v0.8.2 => github.com/afdesk/trivy-kubernetes v0.0.0-20250526113150-fa45b4d1992e
