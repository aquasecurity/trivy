...
require (
	...
	github.com/aquasecurity/trivy-db v0.0.0-20250715075956-68f941d6a641
...
replace github.com/aquasecurity/trivy-db => github.com/DmitriyLewen/trivy-db v0.0.0-20250716092936-a7130ad6ac33
