...
`Trivy` always updates its vulnerability database when it starts operating. This is usually fast, as it is a differential update. But if you want to skip even that, use the `--skip-update` option.
